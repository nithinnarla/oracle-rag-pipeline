"""
ORACLE Cross-Dataset Scale-Up: medqa and pubmed, n=25/band

Extends existing medqa/pubmed pilot samples (n=5/band) toward n=25/band,
matching the scale-up already run for medmcqa/pubmedqa/mirage/plaba.
...
def run_scale_up():
    ...
    print("\n=== NEW SUMMARY (medqa + pubmed, actual condition) ===")
